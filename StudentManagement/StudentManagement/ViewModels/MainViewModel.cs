...
namespace StudentManagement.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            MainWindow.Notify.ShowBalloonTip(3000, "HUMG - Hệ thống quản lý đào tạo", "Chào mừng bạn đến với HUMG", System.Windows.Forms.ToolTipIcon.Info);
            //GotoLayoutView();
        }
        ...
        public void InitAdminNavigationItems()
        {
            ...
            LayoutViewModel.NavigationItems = new ObservableCollection<NavigationItem>() {
                ...
                new NavigationItem("Thêm Sinh viên", false, null, _campusStudentListViewModel, _campusStudentListRightSideBar, LayoutViewModel, "AccountGroupOutline"),
            };
        }
        ...
        public void InitStudentNavigationItems()
        {
            ...
            LayoutViewModel.NavigationItems = new ObservableCollection<NavigationItem>() {
                //new NavigationItem("Tổng quan", false, null, _adminHomeViewModel, _adminHomeRightSideBar, LayoutViewModel, "ViewDashboardOutline"),
                new NavigationItem("Đào ", true, temp, null, null, LayoutViewModel, "SchoolOutline"),
